...
// Indique qu'une annonce coloc a un signalement en attente de revue
// par un admin. Ne révèle pas le motif ni l'identité du rapporteur —
// seulement le fait qu'un signalement existe, pour rester neutre
// avant toute décision.
export default function RoommateReportBadge({ listingId }) {
