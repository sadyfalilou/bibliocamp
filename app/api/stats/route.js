...
export async function GET() {
  ...
  const { data: listings } = await supabase
    .from('listings')
    .select('id, user_id, title, authors, isbn, price, original_price, description, image_url, image_urls, is_bundle, bundle_items, course_code, meet_campus, meet_city, post, created_at')
    .eq('status', 'active')
